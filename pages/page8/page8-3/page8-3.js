document.querySelector(".headerpage8-3").innerHTML += HeaderUI("HOW YOU CAN REDUCE FOOD WASTE");
...
document.querySelector(".BackButton-Page8-3").innerHTML += BackNextButtonUI("Back");
document.querySelector(".NextButton-Page8-3").innerHTML += BackNextButtonUI("Next");